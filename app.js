...
app.post("/add", (req, res) => {
    ...
    res.status(200).json({
        status : "Sucessfull",
        message: "The sum of given two numbers are",
        "sum" : result
    })
...
app.post("/sub", (req, res) => {
    ...
    res.status(200).json({
        status : "Sucessfull",
        message: "the difference of given two numbers are:",
        difference : result
    })
})
...
app.post("/mul", (req, res) => {
    ...
    res.status(200).json({
        status : "Sucessfull",
        message: "The product of given numbers are",
        result : result
    })
})
...
app.post("/div", (req, res) => {
    ...
    res.status(200).json({
        status : "Sucessfull",
        message: "The division of given numbers are:",
        result : result
    })
})
...
app.listen(9001, () => console.log("The server is up"));
